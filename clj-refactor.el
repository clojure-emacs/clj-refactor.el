...
;; Package-Requires: ((emacs "24.4") (s "1.8.0") (seq "2.19") (dash "2.4.0") (yasnippet "0.6.1") (paredit "24") (multiple-cursors "1.2.2") (clojure-mode "5.6.1") (cider "0.11.0") (edn "1.1.2") (inflections "2.3") (hydra "0.13.2"))
  ...
  (let* ((forms (if (region-active-p)
    ...
    (let (ns names target-ns-alias
      ...
      (save-window-excursion
        ...
        (when requires
          (cljr--insert-in-ns ":require")
          (thread-last (--remove (s-matches-p (format target-ns-regexp-template ns) it) requires)
	    (apply #'concat)
	    (s-trim)
	    (insert))
          (cljr-clean-ns))
